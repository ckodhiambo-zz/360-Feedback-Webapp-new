                ...
                <div class="card-tools">
                    <ul class="nav nav-pills ml-auto">
                        <li class="nav-item mr-1">
                            <button class="btn btn-sm btn-primary" @click="createMode"><i
            ...
            <div class="card-body table-responsive p-0">
                <table class="table">
                    ...
                    <tr v-for="user in users" :key="user.id">
                        ...
                        <td>{{ user.email }}</td>
                        <td>
                            <button class="btn btn-sm btn-info" @click="viewUser(user)"><i class="fa fa-eye"></i> View
                            </button>
                            <button class="btn btn-sm btn-warning" @click="editUser(user)"><i class="fa fa-edit"></i>
                                Edit
                            </button>
...
<!--                                <select class="form-control" name="company" required v-model="selectedCompany">-->
...
<!--                                       class="form-control" :class="{'is-invaild': form.errors.has('position')}">-->
...
<!--                            </div>-->
                        ...
                        <div class="modal-footer justify-content-between">
                            ...
                            <button type="submit" v-if="load" v-show="!editMode" class="btn btn-lg btn-primary">Save
                                User
                            </button>
                            <button type="submit" v-if="load" v-show="editMode" class="btn btn-lg btn-success">Update
                                User
                            </button>
                        </div>
                    </form>
...
export default {
    data() {
        return {
            ...
            editMode: false,
            load: true,
            img: 'http://127.0.0.1:8000/img/avatar.png',
            user: {},
            users: [],
            companies: {},
            departments: {},
    ...
    watch: {
        selectedCompany: function (value) {
            axios.get('api/departments?company_id=' + this.selectedCompany)
                .then(response => {
