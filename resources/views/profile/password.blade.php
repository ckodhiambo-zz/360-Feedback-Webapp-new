                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <div class="form-group">
                                        <label for="newpassword" style="color: #0000A0 !important;">Enter New Password</label>
                                    ...
                                    <div class="form-group">
                                        <label for="newpassword_confirmation" style="color: #0000A0 !important;">Confirm New Password</label>
