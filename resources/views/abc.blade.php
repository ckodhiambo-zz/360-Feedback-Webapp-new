    ...
    <div class="card">
        <div class="card-body">
            <div class="card-header text-white bg-info" style="background-color: #0000A0 !important;">
                <h5>Tier Data 360° Feedback Nominations</h5>
            </div>
            ...
            <div class="card" style="margin-top: -20px">
                <div class="card-header">
                    <div class="card-title">
                        <p><strong>Hint:</strong> nominate <strong>at least</strong> 1 supervisor, 1 peer and 1 direct
                                    ...
                                    <td>
                                        <div class="row g-3">
                                            ...
                                            <div class="col">
                                                ...
                                                <div class="form-group">
                                                    <select class="form-control name_list" name="rater_name[1][]"
                                                            required>
                                            ...
                                            <div class="col">
                                                ...
                                                <div class="form-group">
                                                    <select class="form-control name_list" name="relationship_name[1][]"
                                                            required>
    ...
    $(document).ready(function () {
        ...
        $('#add_field').click(function () {
            ...
            $('#dynamic_field1').append(
                ...
                '<div class="col">' +
                '<div class="form-group">' +
                '<select class="form-control name_list" name="rater_name[' + i + '][]" required>' +
                '<option selected disabled>-- Select name --</option>' +
                '@foreach ($companies as $company)' +
                '@foreach ($company->employees as $employee)' +
                '<option class="employees company_{{$company->id}}" value="{{$employee->id}}">{{$employee->first_name}} {{$employee->last_name}}</option>' +
                '@endforeach' +
                '@endforeach' +
                '</select>' +
                '</div>' +
                ...
                '<div class="col">' +
                '<div class="form-group">' +
                '<select class="form-control name_list" name="relationship_name[' + i + '][]" required>' +
                '<option selected disabled>-- Select relationship --</option>' +
                '<option value="Peer">Peer</option>' +
                '<option value="Supervisor">Supervisor</option>' +
                '<option value="Direct_report">Direct report</option>' +
